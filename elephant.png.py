...
path = r"C:\\Users\\ChandiniKalidindi\Downloads\\elaphant_app-main\\elaphant_app-main\\elephant.png"
...
input_label = tk.Label(
    master = input_frame,
    text = 'lbs',
    font = ('Couroer', 30, 'bold'),
    bg = '#BFDCDE',
    fg = 'black'
)
input_entry.insert(0,'0')
input_frame.pack(fill=X,pady = (0),padc = (50,50))
input_label.pack(size = RIGHT, padx = 5)
